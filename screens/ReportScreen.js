...
export default function ReportScreen() {
  ...
  const templates = [
    {
      ...
      icon: "car-sport",
      label: "Accident",
      text: "A traffic accident occurred at this location. ",
    },
    {
      id: 2,
      icon: "flame",
      label: "Fire",
      text: "A fire has been reported at this location. ",
    },
    {
      id: 3,
      icon: "water",
      label: "Flooding",
      text: "Flooding has been observed in this area. ",
    },
    {
      id: 4,
      icon: "construct",
      label: "Infrastructure",
      text: "Infrastructure issue reported: ",
    },
    {
      id: 5,
      icon: "people",
      label: "Public Event",
      text: "A public event is taking place at this location. ",
    },
    {
      id: 6,
      icon: "warning",
      label: "Emergency",
      text: "Emergency situation reported: ",
    },
    {
      id: 7,
      icon: "megaphone",
      label: "Protest",
      text: "A protest or demonstration is occurring at this location. ",
    },
  ...
  const handleImageFromGallery = async () => {
    if (media.length >= 10) {
      Alert.alert(
        "Limit Reached",
        "You can only add up to 10 photos or videos."
      );
      return;
    }
  ...
  const getCurrentLocation = async () => {
    try {
      ...
      Alert.alert(
        "Error",
        "Unable to access location services. Please check your permissions."
      );
    }
  };
            ...
            results.slice(0, 8).map(async (result) => {
              try {
                ...
                if (address[0]) {
                  ...
                  return {
                    address: fullAddress,
                    shortAddress: `${addr.street || addr.name || ""}, ${
                      addr.city || ""
  ...
  const openMapPicker = async () => {
    ...
    if (status !== "granted") {
      Alert.alert(
        "Permission Denied",
        "Please enable location permissions to use maps."
      );
      return;
    }
      ...
      if (selectedCoordinates) {
        ...
        try {
          ...
          if (results && results.length > 0) {
            ...
            Alert.alert(
              "Invalid Location",
              "Please select a valid location or use the map picker."
            );
            setIsSubmitting(false);
            return;
          }
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={{ color: colors.gray, fontSize: 13, lineHeight: 18 }}>
            Your identity will be protected. All reports are submitted
            anonymously.
          </Text>
        </View>
      </View>
      ...
      <View style={{ position: "relative", zIndex: 1000 }}>
        ...
        >
          <TextInput
            ...
            placeholderTextColor={colors.gray}
          />
          <TouchableOpacity style={{ padding: 8 }} onPress={openMapPicker}>
      ...
      <View style={styles.imageButtonsContainer}>
        ...
        >
          <Ionicons
            name="camera-outline"
            size={22}
            color={media.length >= 10 ? colors.gray : colors.primary}
          />
          <Text
            style={[
              styles.uploadText,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Your report will be submitted anonymously and reviewed by our
              team.
            </Text>
      ...
      >
        <View style={{ flex: 1 }}>
          ...
          <View style={{ padding: 16, backgroundColor: colors.background }}>
            {location ? (
              <Text
                style={{ color: colors.text, marginBottom: 12, fontSize: 14 }}
              >
                📍 {location}
              </Text>
            ) : null}
